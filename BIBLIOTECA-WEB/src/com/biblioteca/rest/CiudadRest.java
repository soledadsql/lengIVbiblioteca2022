...
public class CiudadRest {
	...
	public Map<String, Object> consultarPorNombre(@QueryParam("nombreQP") String descripcion) {
		...
		try {
			retorno.put("success", true);
			retorno.put("ciudad", cs.consultarCiudadesPorNombre(descripcion));
		} catch (Exception e) {
			retorno.put("error", e.getMessage());
			retorno.put("success", false);
		}
	...
	public Map<String, Object> incluir(Ciudad ciudad) {
		...
		try {
			retorno.put("success", true);
			retorno.put("ciudad", cs.incluir(ciudad));
		} catch (Exception e) {
			retorno.put("error", e.getMessage());
			retorno.put("success", false);
		}
	...
	public Map<String, Object> editar(Ciudad ciudad) {
		...
		try {
			retorno.put("success", true);
			retorno.put("ciudad", cs.editar(ciudad));
		} catch (Exception e) {
			retorno.put("error", e.getMessage());
			retorno.put("success", false);
		}
	...
	public Map<String, Object> actualizar(Ciudad ciudad) {
		...
		try {
			retorno.put("success", true);
			retorno.put("ciudad", cs.actualizar(ciudad));
		} catch (Exception e) {
			retorno.put("error", e.getMessage());
			retorno.put("success", false);
		}
